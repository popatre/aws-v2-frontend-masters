        ...
        <main className="h-screen">
            ...
            <div className="grid grid-cols-12 grid-rows-1 gap-4 h-full">
                <Navigation>
                    ...
                    <NavigationLink to="/notes/hipster">
                        Hipster Ipsum
                    </NavigationLink>
                    <NavigationLink to="/notes/zombie">
                        Zombie Ipsum
                    </NavigationLink>
                    <NavigationLink to="/notes/cupcake">
                        Cupcake Ipsum
                    </NavigationLink>
                    <NavigationLink to="/notes/cheese">
                        Cheese Ipsum
                    </NavigationLink>
                    <NavigationLink to="/notes/cat">Cat Ipsum</NavigationLink>
                    <NavigationLink to="/notes/office">
                        Office Ipsum
                    </NavigationLink>
